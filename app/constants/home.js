...
export const transformacionMetrics = [
  { value: '70%', label: 'menos tiempo en tareas repetitivas que no generan valor' },
  { value: '8x', label: 'más rápido para analizar datos y tomar decisiones' },
  { value: '+80%', label: 'de capacidad operativa sin sumar personal' }
]
