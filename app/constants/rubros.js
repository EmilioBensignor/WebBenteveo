export const rubros = {
  ...
  'real-estate': {
    ...
    pasos: {
      ...
      items: [
        { texto: 'El cliente define qué busca', imagen: '/img/transformacion/video-thumb.png' },
        { texto: 'El agente escanea los portales', imagen: '/img/transformacion/video-thumb.png' },
        { texto: 'La propuesta llega al cliente', imagen: '/img/transformacion/video-thumb.png' },
        { texto: 'El seguimiento es automático', imagen: '/img/transformacion/video-thumb.png' },
      ],
    },
    automatizaciones: [
      {
