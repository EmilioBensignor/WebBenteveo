<template>
  <Section bg="bg-amarillo" class="py-20 md:py-28 lg:py-40 px-4 md:px-7 lg:px-16 xxl:px-32">
    <template #background>
    ...
    <h2
      ...
      <template v-for="(b, i) in beneficios" :key="b.title">
        ...
        <span tabindex="0"
          class="group inline-block relative bg-negro rounded-2xl lg:rounded-3xl text-amarillo whitespace-nowrap cursor-default transition-transform duration-300 hover:-rotate-2 hover:scale-[1.03] focus-visible:-rotate-2 outline-none px-3 lg:px-5 py-0.5 lg:py-1">
          {{ b.title.toLowerCase() }}
          <span
