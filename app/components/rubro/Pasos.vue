<template>
  <DefaultSection bg="bg-amarillo" class="px-4 md:px-7 lg:px-16 xxl:px-30 py-14 md:py-16 lg:py-24">
    <template #background>
    ...
    <div class="flex flex-col items-center gap-3 md:gap-4 text-center">
      <UiHeadingH2 class="text-negro-puro font-bold">Mira cómo funciona en la práctica</UiHeadingH2>
    ...
    <UiCarouselStatic class="w-[calc(100%+2rem)] md:w-full -mx-4 md:mx-0"
      ...
      <div v-for="a in automatizaciones" :key="a.titulo"
        ...
        <div class="flex flex-col gap-3 md:gap-4">
          <UiHeadingH3 class="text-amarillo font-bold">{{ a.titulo }}</UiHeadingH3>
