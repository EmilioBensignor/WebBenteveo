<template>
  <footer
    class="w-full flex justify-center  bg-[linear-gradient(180deg,#000_0%,#131313_33%,#131313_66%,#000_100%)] py-8 px-4">
    <div class="w-full max-w-344 flex flex-col gap-6">
      ...
      <div class="flex flex-col gap-6 lg:flex-row lg:justify-between lg:items-center">
        <nav class="flex flex-col gap-6 lg:flex-row lg:gap-6">
...
<script setup>
const links = ['Servicios', 'Proyectos', 'Nosotros', 'Novedades']
