<template>
  <Section>
    <HeadingH2 class="max-w-80 sm:max-w-full text-center px-4 md:px-7 lg:px-16 xxl:px-30">
    ...
    <CarouselStatic :slides-per-view="{ base: 1.3, sm: 1.8, tab: 2.4, md: 3, lg: 3, xl: 3, xxl: 4 }"
      ...
      class="md:px-8 lg:px-16 xxl:px-30">
    ...
    <CarouselStatic :slides-per-view="{ base: 1.3, sm: 1.8, tab: 2, md: 2, lg: 2, xl: 2, xxl: 2 }"
      :gap="{ base: 8, md: 16, lg: 16, xl: 16, xxl: 16 }" class="md:px-8 lg:px-16 xxl:px-30">
