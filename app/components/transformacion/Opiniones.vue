<template>
  <Section>
    <HeadingH2 class="max-w-80 sm:max-w-full text-center px-4 md:px-7 lg:px-16">
      <span>Confianza construida sobre</span> <span class="text-amarillo">resultados tangibles</span>
    </HeadingH2>
    <CarouselStatic :slides-per-view="{ base: 1.3, sm: 1.8, tab: 2.4, md: 3, lg: 3, xl: 3, xxl: 4 }"
      :gap="{ base: 8, md: 16, lg: 16, xl: 16, xxl: 16 }"
      :button-position="{ top: '50%', transform: 'translateY(-50%)', left: { base: '0.5rem', md: '1rem', lg: '2.75rem', xl: '2.75rem', xxl: '2.75rem' }, right: { base: '0.5rem', md: '1rem', lg: '2.75rem', xl: '2.75rem', xxl: '2.75rem' } }"
      class="md:px-8 lg:px-16">
      <OpinionCard v-for="op in opiniones" :key="op.autor + op.empresa" :op="op" />
    </CarouselStatic>
    <CarouselStatic :slides-per-view="{ base: 1.3, sm: 1.8, tab: 2, md: 2, lg: 2, xl: 2, xxl: 2 }"
      :gap="{ base: 8, md: 16, lg: 16, xl: 16, xxl: 16 }" class="md:px-8 lg:px-16">
